jQuery(function(a) {
    ...
    function() {
        ...
        function(b) {
            ...
            p.fadeOut(500,
            function() {
                k.hasClass("push-next") && (k.removeClass("push-next"), k.addClass("pushed-next")),
                k.hasClass("push-prev") && (k.removeClass("push-prev"), k.addClass("pushed-prev")),
                document.title = a("<textarea/>").html(e).text(),
                p.html(d),
                l.removeClass(),
    ...
    function(b) {
        ...
        if (c.hasClass("post-nav-item") || c.hasClass("pagination-item") ? ((c.hasClass("post-nav-next") || c.hasClass("pagination-next")) && (k.removeClass("pushed-prev"), k.addClass("push-next")), (c.hasClass("post-nav-prev") || c.hasClass("pagination-prev")) && (k.removeClass("pushed-next"), k.addClass("push-prev"))) : (k.removeClass("pushed-next"), k.removeClass("pushed-prev")), o === !1) {
            ...
            e.replace(/\/$/, "") !== d.url.replace(/\/$/, "") && (o = !0, k.addClass("loading"), NProgress.start(), n.pushState({},
            f, e))
        }
    }), void a("body").on("click", "#post-index .post .js-ajax-link",
    function() {
